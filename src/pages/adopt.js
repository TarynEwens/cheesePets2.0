          ...
          <form onSubmit={handleSubmit} className="adoption__form">
            ...
            <fieldset>
              ...
              <label htmlFor="puppy" className={"adoption__label"}>
                ...
                />
                <span>
                  <input id="puppy" type="radio" name="species" value="Puppy" onChange={handleInputChange}  className={"adoption__radioButton"} />
                  Pug
                </span>
              </label>
              ...
              <label htmlFor="axolotl" className={"adoption__label"}>
                ...
                />
                <span>
                  <input id="axolotl" type="radio" name="species" value="Axolotl" onChange={handleInputChange} className={"adoption__radioButton"} />
                  Axolotl
                </span>
              </label>
              ...
              <img
                ...
                />
                <span>
                  <input id="rat" type="radio" name="species" value="Rat" onChange={handleInputChange} className={"adoption__radioButton"} />
                  Rat
                </span>
              </label>
              ...
              <img
                ...
                />
                <span>
                  <input id="kitten" type="radio" name="species" value="Kitten" onChange={handleInputChange} className={"adoption__radioButton"} />
                  Kitten
                </span>
              </label>
              </div>
            </fieldset>
            <label htmlFor="name" className={"adoption__nameLabel"}>Name your pet: <input id="name" name="name" type="text" placeholder="name" onChange={handleInputChange} value={formValues.name} required/></label>
